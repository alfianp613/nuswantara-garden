...
<card class="card" style="width: 75%%">
    <div class="card-body">
        <form id="formtable" method="post" action="/dashboard/project/{{$project->slug}}" enctype="multipart/form-data">
        @method('put')
        @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input
                    ...
                    value="{{ old('target_pendanaan', $project->target_pendanaan) }}"
                    required
                />
            ...
            <div class="mb-3">
                ...
                @enderror
                <input id="deskripsi_project" type="hidden" name="deskripsi_project" value="{{old('deskripsi_project', $project->deskripsi_project)}}">
